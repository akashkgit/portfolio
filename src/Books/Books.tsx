...
export function ZeroToOne(){
    return <div className="ZeroToOne">
            ...
            <p className="j">A startup/company with a unique product is meant to have gone from 0 to 1. But, any company replicating the existing product/styles is said to go from 1 to n. These 1 to n stages are termed as Globalisation. The 0 to 1 stage is called as Technology/advancement. For example, Amazon was found in 1994. Flipkart was found in 2007. Here, Flipkart has just made a globalisation of online store which was already started in the states. Similarly, Zomato was founded in 2008 and led to a food delivery mania which is still going on and have led lot of company to like uber(uber eats),food panda et cetera.</p><div className="ztoI"></div>
...
export function Essentialism(){
    return <div className="essentialism">
        ...
        {/* <div className="eC"> */}
            ...
            <p className="j">Yes!Dont say 'yes' by default.Dont say "yes" so that the requestor does not resent you. So, Learn to say no, If you dont prioritise, Someone's priority will become yours</p>
            
                <p className="j"> Decision ThinkingWhen making a Decision, Dont decide on the recent option that you heard about. Take some time. explore all the options. Evaluate the tradeoff that each option has. By choosing one option, You must be ready to confront the trade offs caused by leaving the remaining. Tradeoff is inevitable in any decision. Your decision should resonate with your Essential intent/ Vision. If yes, then your single decision should simplify thousand upcoming Conundrum. Dont get intimidated by the mertis of left opitions. Have a buffer as the future is uncertain. Not everyone needs to accept your decision until you know what you are doing. Be ready to face criticisms and mockery. Get uncomfortable !</p>
                <div className="eI"></div>
                <p className="j"> Dont do other's work. You can aid them.But, never take it completely on your head. By doing so, you are decreasing their chances of improvement. So, never count the teeth in other's mouth. When one asks for help, check if you are the apt person to do the deed. Else, refer a qualified person to handle that.</p>
            
                <p className="j">Start small and progress. celebrate small achievements that will lead you to your vision.By Starting big, its highly probable for one to get overwhelmed.</p>
                <p className="j">Dont fall for sun bias cost. For example, when your made a grave mistake and started realising it, be ready to accept your mistake and back off. Instead dont proceed with the mistake since you did!</p>
                <p className="j">Dont dont many things parallely. That doesnot make significant impact in those activities. Instead of doing 1mm in 10 task, put all the 1mm in one task and make 10mm work that makes significance. So, do less but btetter. So, there is a difference between multi tasking and multi focussing. You can only focus a single activity at a time. But, can do two or more that does not require your focus.</p>
